...
val buttons = listOf<CalcButton>(
    CalcButton(symbol = "AC", span = 2, event = CalculatorEvent.Clear),
    CalcButton(symbol = "<", event = CalculatorEvent.Delete),
    CalcButton(symbol = "/", event = CalculatorEvent.Operation(op = CalculatorOp.Divide)),
    ...
    CalcButton(symbol = "x", event = CalculatorEvent.Operation(op = CalculatorOp.Multiply)),
    ...
    CalcButton(symbol = "-", event = CalculatorEvent.Operation(op = CalculatorOp.Subtract)),
    ...
    CalcButton(symbol = "+", event = CalculatorEvent.Operation(op = CalculatorOp.Add)),
    CalcButton(symbol = "0", span = 2, event = CalculatorEvent.Number(number = 0)),
    CalcButton(symbol = ",", event = CalculatorEvent.Decimal),
    CalcButton(symbol = "=", event = CalculatorEvent.Calculate),
)
